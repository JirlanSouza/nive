...
flowchart LR
    ...
    lucide["Lucide Icons<br/>Conjunto de ícones SVG, sincronizado em build-time pela CLI"]
    ...
    nive -->|nive icons sincroniza glifos de| lucide
    ...
    class nive system;
    class iced,os,registry,lucide external;
```
