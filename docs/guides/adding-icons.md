...
The framework includes essential icons available through the `nive` prelude:
...
### Scaffolded App Recipes

Apps generated by `nive new` include matching `just` recipes:
...
```rust
use crate::widgets::icon::IconName;
use nive::prelude::Icon;
