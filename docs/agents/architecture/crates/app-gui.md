...
- `dev`: app-domain fixture-provider functions, probe env/store ownership and the `DevtoolsApp` hooks that provide state snapshots plus command/probe application to the runtime.
