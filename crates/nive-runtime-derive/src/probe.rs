    ...
    quote! {
        impl #impl_generics #ident #type_generics #where_clause {
            pub(crate) const ALL: &'static [Self] =
                <Self as nive_runtime::devtools::probe::ProbeCatalogEntry>::ALL;

            pub(crate) fn meta(self) -> nive_runtime::devtools::probe::ProbeMeta {
                <Self as nive_runtime::devtools::probe::ProbeCatalogEntry>::meta(self)
            }
        }

        impl #impl_generics nive_runtime::devtools::probe::ProbeCatalogEntry
            for #ident #type_generics #where_clause
        {
            const ALL: &'static [Self] = &[#(Self::#variants),*];

            fn meta(self) -> nive_runtime::devtools::probe::ProbeMeta {
                match self {
                    #(#arms),*
                }
            }
...
fn probe_meta_arm(variant: &crate::parse::ParsedVariant) -> TokenStream {
    ...
    quote! {
        Self::#ident => nive_runtime::devtools::probe::ProbeMeta::new(
            #key,
            #short_key,
            #summary,
            nive_runtime::devtools::probe::ProbeErrorScope::#kind,
        )
    }
}
