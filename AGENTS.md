...
- Development planning and OpenSpec usage: `docs/agents/development-workflow.md`
...
- Start with the least bureaucratic planning level compatible with the impact:
  `Direct`, `Issue`, or `OpenSpec`.
- Never create a new OpenSpec change unless the user explicitly requests it or
  explicitly accepts a recommendation. A referenced existing change may be used.
- Do not create or modify GitHub Issues or Project items without an explicit request.
